...
<div class="p-4 bg-white shadow-sm">
    ...
    <form method="POST" wire:submit.prevent="store" id="inscriptionForm" autocomplete="off">
        ...
        <div class="block mb-6 px-5">
            ...
            <input type="text" wire:model.lazy="matricule" class="block mt-1 rounded-md border-gray-300 w-full @error('matricule') border-red-500 bg-red-100  @enderror"  name="matricule" id="matricule" value="{{ old('matricule') }}" readonly>
        ...
        <div class="block px-5 mb-6">
            <label for="classe">Classe d'affectation</label>
            <div class="relative">
