    ...
    <form method="POST" wire:submit.prevent="store" enctype="multipart/form-data">
        ...
        <div class="p-5 flex flex-col gap-4">
            <div class="block mb-5">
                ...
                <input type="text"
                    class="block mt-1 rounded-md border-gray-300 w-full @error('code') border-red-500 bg-red-100  @enderror" wire:model="matricule" name="matricule" id="matricule" value="{{old('matricule')}}">
            ...
            <div class="block mb-5">
                ...
                <input type="text" class="block mt-1 rounded-md border-gray-300 w-full @error('prenom') border-red-500 bg-red-100  @enderror" wire:model="age" name="age" id="age" required step="1" pattern="\d+" min="0">
