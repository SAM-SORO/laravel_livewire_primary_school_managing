    ...
    <form method="POST" wire:submit.prevent="store" id="inscriptionForm">
            ...
            <div class="p-5 flex flex-col">
                ...
                <div class="block mb-5 px-5">
                    ...
                    <input type="text" wire:model.lazy="matricule" class="block mt-1 rounded-md border-gray-300 w-full @error('matricule') border-red-500 bg-red-100  @enderror"  name="matricule" id="matricule" value="{{ old('matricule', $matricule) }}" readonly>
                ...
                <div class="block px-5 mb-5">
                    <label for="montantScolarite">Montant de la scolarité</label>
                    <input type="number" class="block mt-1 rounded-md border-gray-300 w-full" wire:model="montantScolarite" id="montantScolarite" readonly>
                </div>

                <div class="block px-5 mb-5">
                    <label for="Somme_paye">Somme payé</label>
