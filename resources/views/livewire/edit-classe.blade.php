        ...
        <form method="POST" wire:submit.prevent="store">
            ...
            <div class="p-5 flex flex-col">
                ...
                <div class="p-5">
                    ...
                    <div class="relative">
                        <select wire:model="idBatiment" name="idBatiment" class="block appearance-none w-full bg-white border border-gray-300 hover:border-gray-400 px-4 py-2 pr-8 rounded-md shadow-sm focus:outline-none focus:border-blue-500 focus:ring focus:ring-blue-200">
                ...
                <div class="p-5">
                    ...
                    <input type="number"
                        class="block mt-1 rounded-md border-gray-300 w-full @error('capaciteClasse') border-red-500 @enderror"
                        wire:model="capaciteClasse" name="capaciteClasse" required step="1" pattern="\d+" min="0"
                    >
