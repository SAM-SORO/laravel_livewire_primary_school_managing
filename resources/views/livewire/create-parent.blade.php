    ...
    <form method="POST" wire:submit.prevent="store">
        ...
        <div class="p-5 flex flex-col gap-4">
            ...
            <div class="block mb-5">
                ...
                <input type="text"
                    class="block mt-1 rounded-md border-gray-300 w-full @error('nom') border-red-500 bg-red-100 @enderror" wire:model="nom" name="nom" required>
            ...
            <div class="block mb-5">
                ...
                <input type="text"
                    class="block mt-1 rounded-md border-gray-300 w-full @error('prenom') border-red-500 bg-red-100  @enderror" wire:model="prenom" name="prenom" required>
            ...
            <div class="block mb-5">
                ...
                <input type="text"
                    class="block mt-1 rounded-md border-gray-300 w-full @error('email') border-red-500 bg-red-100  @enderror" wire:model="email" name="email" required>
            ...
            <div class="block mb-5">
                <label for="matricule">Matricule de l'enfant</label>
                <input type="text"
                    class="block mt-1 rounded-md border-gray-300 w-full @error('matricule') border-red-500 bg-red-100  @enderror" wire:model.lazy="matricule" name="matricule" required>
            ...
            <div class="block mb-5">
                ...
                <input type="text" class="block mt-1 rounded-md border-gray-300 w-full @error('contact') border-red-500 bg-red-100 @enderror" wire:model="contact" oninput="formatContact(this)" name="contact" readonly required>
