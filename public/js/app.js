...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var menuDeroulantInscrit = document.getElementById('dropdownBoutonFiltreInscrit');
  if (menuDeroulantInscrit) {
    ...
    var dropdownItems1 = document.querySelectorAll('#dropdownFiltreInscrit a');
    dropdownItems1.forEach(function (item) {
      item.addEventListener('click', function () {
        var selectedOptionText = item.textContent.trim(); // Récupérer le texte de l'option sélectionnée
  ...
  // Écouteur d'événement pour ouvrir/fermer le menu déroulant lors du clic sur le bouton
  var menuDeroulantNiveau = document.getElementById('dropdownBoutonFiltreNiveau');
  if (menuDeroulantNiveau) {
    ...
    // Ajouter des écouteurs d'événements pour mettre à jour le texte du bouton lors de la sélection d'une option
    var dropdownItems2 = document.querySelectorAll('#dropdownFiltreNiveau a');
  ...
  // Écouteur d'événement pour ouvrir/fermer le  menu déroulant lors du clic sur le bouton
  var menuDeroulantAffecter = document.getElementById('dropdownBoutonFiltreAffecter');
  if (menuDeroulantAffecter) {
    ...
    // Ajouter des écouteurs d'événements pour mettre à jour le texte du bouton lors de la sélection d'une option
    var dropdownItems3 = document.querySelectorAll('#dropdownFiltreAffecter a');
  ...
  // Écouteur d'événement pour ouvrir/fermer le  menu déroulant lors du clic sur le bouton
  var menuDeroulantClasse = document.getElementById('dropdownBoutonFiltreClasse');
  if (menuDeroulantClasse) {
    ...
    // Ajouter des écouteurs d'événements pour mettre à jour le texte du bouton lors de la sélection d'une option
    var dropdownItems4 = document.querySelectorAll('#dropdownFiltreClasse a');
  ...
  document.addEventListener('click', function (event) {
    ...
    dropdowns.forEach(function (dropdown) {
      var dropdownButton = document.getElementById(dropdown.dataset.dropdownToggle);
